...
\outerlist{
    ...
    \innerlist{
        ...
        \entry{Création de plusieurs projets internes pour améliorer les workflows des collaborateurs en utilisant les LLMs, le fine-tuning, la vision par ordinateur et la curation/validation de données.}
    }
...
\sidebyside
    {
        ...
        \outerlist{
            ...
            \entry{\textbf{Compétences humaines:} Curiosité, Résolution de problèmes, Communication, Collaboration, Travail d'équipe}
        }
    }
    {
        \section{Langues}
